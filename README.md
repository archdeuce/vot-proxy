# Прокси сервер для [voice-over-translation](https://github.com/ilyhalight/voice-over-translation)

Обходит блокировки Яндекса не на территории РФ. Можно использовать оф. расширение, а в качестве прокси указать свой сервер.
